...
interface Props {
  ...
  fichaId: number | null; // ID de la ficha a editar
}
...
const FormularioUpFichaSena: React.FC<Props> = ({
  isModalOpen,
  setIsModalOpen,
  setEvento,
  setShowToast,
  ...
  const formik = useFormik<FormValues>({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        ...
        await axios.put(`fichas/${fichaId}`, payload);
      ...
      if (fichaId && isModalOpen) {
        ...
        try {
          ...
          formik.setValues({
            ...
            idInfraestructura: ficha.idInfraestructura || undefined,
...
export default FormularioUpFichaSena;