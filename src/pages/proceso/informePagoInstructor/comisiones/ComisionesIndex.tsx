...
const ComisionesIndex: React.FC<ComisionesIndexProps> = ({
  idContrato,
  idRmi,
  fechaMaxima,
  fechaMinima
  ...
  const loadData = async () => {
    ...
    try {
      const res = await axios.get(
        `comisiones-instructores?idContrato=${idContrato}&idRmi=${idRmi}`
      );
  ...
  const handleOpenEdit = (comision: Comision) => {
    setForm({
      ...
      fechaInicialDesplazamiento: comision.fechaInicialDesplazamiento
        ? comision.fechaInicialDesplazamiento.slice(0, 10)
        : '',
      fechaFinalDesplazamiento: comision.fechaFinalDesplazamiento
        ? comision.fechaFinalDesplazamiento.slice(0, 10)
        : '',
      item: comision.item || ''
    });
            ...
            {comisiones.length === 0 ? (
              ...
              comisiones.map((comision) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">
                    {comision.fechaInicialDesplazamiento
                      ? comision.fechaInicialDesplazamiento.slice(0, 10)
                      : '-'}
                  </td>
                  <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">
                    {comision.fechaFinalDesplazamiento
                      ? comision.fechaFinalDesplazamiento.slice(0, 10)
                      : '-'}
                  </td>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({ ...form, fechaInicialDesplazamiento: e.target.value })
                    }
