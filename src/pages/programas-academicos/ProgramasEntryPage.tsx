...
/**
 * Página de entrada a Planeación.
...
const ProgramasEntryPage: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh]">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">Cargando planeación...</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] p-6">
      <h1 className="text-2xl font-semibold text-gray-800 dark:text-white mb-2">Planeación</h1>
      <p className="text-center text-gray-600 dark:text-gray-400 mb-6">
        No hay redes configuradas. Crea una red primero para gestionar la planeación.
      </p>
      <button
