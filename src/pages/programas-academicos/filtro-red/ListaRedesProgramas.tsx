...
import RedCardProgramas from './RedCardProgramas';
...
const ListaRedesProgramas: React.FC<Props> = ({ searchTerm, evento, setEvento }) => {
...
export default ListaRedesProgramas;
