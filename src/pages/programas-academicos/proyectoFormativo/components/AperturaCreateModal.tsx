  ...
  const getStepForField = (field: string) => {
    switch (field) {
      ...
      case 'tipoCalificacion':
        return 0;
      case 'fechaInicialInscripciones': // ← step 1
      case 'fechaFinalInscripciones':
        return 1;
      case 'fechaInicialMatriculas': // ← step 2
      case 'fechaFinalMatriculas':
        return 2;
      case 'fechaInicialClases': // ← step 3
      case 'fechaFinalClases':
        return 3;
      case 'fechaInicialPlanMejoramiento': // ← step 4
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      {formErrors.idPeriodo && (
                        <p className="text-xs text-red-500 mt-1">{formErrors.idPeriodo}</p>
                      )}
                    </div>
                      ...
                      >
                        ...
                        {(sedes || []).map((s) => (
                          <option key={s.id} value={s.id}>
                            {s.nombre}, {s.centro_formacion.nombre}
                          </option>
                        ))}
                      </select>
                      {formErrors.idSede && (
                        <p className="text-xs text-red-500 mt-1">{formErrors.idSede}</p>
                      )}
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      {formErrors.idJornada && (
                        <p className="text-xs text-red-500 mt-1">{formErrors.idJornada}</p>
                      )}
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      {formErrors.tipoCalificacion && (
                        <p className="text-xs text-red-500 mt-1">{formErrors.tipoCalificacion}</p>
                      )}
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      {formErrors.fechaInicialClases && (
                        <p className="text-xs text-red-500 mt-1">{formErrors.fechaInicialClases}</p>
                      )}
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-gray-600 dark:text-gray-400">
                      ...
                      {formErrors.fechaFinalClases && (
                        <p className="text-xs text-red-500 mt-1">{formErrors.fechaFinalClases}</p>
                      )}
                    </div>
                  </div>
                </div>
              ...
              {currentStep === 4 && (
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-gray-600 dark:text-gray-400">
                        Fecha inicio plan mejoramiento
                      </label>
                      <input
                        type="date"
                  ...
                  <div className="space-y-1.5">
                    ...
                    {formErrors.observacion && (
                      <p className="text-xs text-red-500 mt-1">{formErrors.observacion}</p>
                    )}
                  </div>
                </div>
              )}
              ...
              {currentStep === 5 && (
                <div className="space-y-4">
                  <div className="space-y-1.5 mb-4">
                    ...
                    {formErrors.pension && (
                      <p className="text-xs text-red-500 mt-1">{formErrors.pension}</p>
                    )}
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        ...
                        {formErrors.valorPension && (
                          <p className="text-xs text-red-500 mt-1">{formErrors.valorPension}</p>
                        )}
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-xs font-bold text-gray-600 dark:text-gray-400">
                          Porcentaje Mora Pensión
                        </label>
                        <input
                          type="number"
                          step="0.01"
