  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-2 sm:p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
      <div className="relative w-full max-w-6xl bg-white dark:bg-coal-500 rounded-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden border border-gray-200 dark:border-gray-700">
        ...
        <div className="flex-1 px-6 py-4 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="date"
                value={formatearFecha(trimestre.fechaInicio)}
                disabled
                className="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 rounded-lg bg-gray-100 dark:bg-coal-400 text-gray-600 dark:text-gray-600"
              />
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border-2 border-primary rounded-lg bg-white dark:bg-coal-400 text-gray-800 dark:text-gray-600 focus:ring-2 focus:ring-primary"
              />
            </div>
          </div>
        ...
        {/* FOOTER */}
        <div className="p-2 border-t-2 border-gray-200 dark:border-gray-600 flex gap-3">
          <button
            onClick={onGuardar}
            disabled={guardando}
